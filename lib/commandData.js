...
class CommandContent {
	...
	constructor(commandName, options) {
		...
		this.#options = options;//format de #options: [ {'name':'a',value:'a'}, { 'name':'b', 'value':'123' } ]
	...
	static fromMessage(message) {
		const options = libCommand.splitCommand(message.content) || [];//on suppose que le préfix est enlevé
