...
export function getDateSinceDiscord(snowflake) { return new Snowflake(snowflake).msecSinceDiscord; }
export function getDateSinceEpoch(snowflake) { return new Snowflake(snowflake).msecSinceEpoch; }
export function isSnowflake(text) { return typeof text == 'string' && text.match(/^\d{10,30}$/) != null; }
...
export default {
	...
	getDateSinceDiscord,
	getDateSinceEpoch,
	getWorker(snowflake) { return new Snowflake(snowflake).worker; },
	getPid(snowflake) { return new Snowflake(snowflake).pid; },
	getIncrement(snowflake) { return new Snowflake(snowflake).increment; },
