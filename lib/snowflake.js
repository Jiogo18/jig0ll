...
module.exports = {
	...
	getDateSinceDiscord(snowflake) { return new Snowflake(snowflake).msecSinceDiscord; },
	getDateSinceEpoch(snowflake) { return new Snowflake(snowflake).msecSinceEpoch; },
	...
	isSnowflake(text) { return typeof text == 'string' && text.match(/^\d{10,30}$/) != null; }
}